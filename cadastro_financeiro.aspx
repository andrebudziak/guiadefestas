               ...
               <tr>
                   <td align="center">
                       <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                           <ContentTemplate>
                               <asp:GridView ID="grdFinanceiro" runat="server" AllowPaging="True" 
                                   CellPadding="4" DataSourceID="ObjectDataSource1" Font-Names="Arial" 
                                   Font-Size="11px" ForeColor="#333333" GridLines="None" Width="800px" 
                                       ...
                                       <asp:TemplateField HeaderText="Anunciante">
                                           <ItemTemplate>
                                               <asp:DropDownList ID="ddlCliente" runat="server" AutoPostBack="True" 
                                                  DataTextField="razao_social" DataValueField="codigo" SelectedValue='<%# Bind("codigo_cliente")%>'
