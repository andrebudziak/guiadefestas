...
public partial class cadastro_categoria_anuncio : System.Web.UI.Page
{
    ...
    protected void grdCategoriaAnuncio_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        int codigo = Convert.ToInt32(((Label)grdCategoriaAnuncio.Rows[index].FindControl("lblCodigo")).Text);
